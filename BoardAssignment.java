...
class BoardAssignment
{
    ...
    public static final int cx[] = {3, -3, 0, 0, 2, 2, -2, -2};
    public static final int cy[] = {0, 0, 3, -3, -2, 2, 2, -2};
    ...
    Cell nextMove(int a[], Cell cell)
    {
        ...
        for (int count = 0; count < cx.length; ++count)
        {
            int i = (start + count) % cx.length;;
            nx = cell.x + cx[i];
            ny = cell.y + cy[i];
            if ((isempty(a, nx, ny)) &&
    ...
    public static void main(String[] args)
    {
        ...
        while (!new BoardAssignment().findClosedTour())
        {
            ;
        }
    }
